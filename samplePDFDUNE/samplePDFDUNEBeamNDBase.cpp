...
void samplePDFDUNEBeamNDBase::Init() {
...
int samplePDFDUNEBeamNDBase::setupExperimentMC(int iSample) {
...
int samplePDFDUNEBeamNDBase::ReturnKinematicParameterFromString(std::string KinematicParameterStr) {
  return -1;
}

std::string samplePDFDUNEBeamNDBase::ReturnStringFromKinematicParameter(int KinematicParameter) {
  return "";
}
