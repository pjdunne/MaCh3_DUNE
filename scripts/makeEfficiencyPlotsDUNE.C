...
void makeEfficiencyPlotsDUNE(TString inputfile)
{
...
//     Hists.clear();
   ...
   //c0->Update();
   c0->cd(3);
   reconmuons->Divide(truenmuons);
   reconmuons->SetTitle("Number of Reco Muons with Reco Cuts/Number of True Muons with truth cuts");
   reconmuons->Draw("HIST");
   c0->Update();
   c0->Print("efficiencyvars.ps");
